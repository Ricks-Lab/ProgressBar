...
from PBmodules import __version__, __status__

if sys.version_info < (3, 6):
    print('progressbar requires at least Python 3.6.')
    sys.exit(1)
...
setup(name='progressbar',
      ...
      url='https://github.com/Ricks-Lab/progress-bar',
      packages=find_packages(include=['progressbar']),
      include_package_data=True,
      scripts=['pb-test'],
      license='GPL-3',
      python_requires='>=3.6',
      project_urls={'Bug Tracker':   'https://github.com/Ricks-Lab/progress-bar/issues',
                    'Documentation': 'https://github.com/Ricks-Lab/progress-bar/blob/master/README.md',
                    'Source Code':   'https://github.com/Ricks-Lab/progress-bar'},
      ...
      install_requires=[],
      data_files=[('share/progressbar/doc', ['README.md', 'LICENSE'])])
